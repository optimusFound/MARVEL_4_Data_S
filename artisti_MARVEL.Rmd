...
<figure><img src="Final_works_images/full_nodes.svg" alt="Collaborazioni tra artisti" style="max-width: 60%;"/></figure>
:::
...
**Brian Michael Bendis** si distingue per aver pubblicato frequentemente con artisti di grande rilevanza, come evidenziato dalle sue alte centralità di Eigenvector Centrality  e PageRank.
...
::: {style="text-align: center;"}
<figure><img src="Final_works_images/golden.svg" alt="Collaborazioni tra artisti" style="max-width: 60%;"/></figure>
:::
...
highlighted_table |>
  knitr::kable(
    format = "html",
    escape = FALSE,
    col.names = c("", "Degree", "Cluster", "Eigenvector", "PageRank", "Closeness", "Betweeness"),
    align = c('l', 'c', 'c', 'c', 'c'),
...
**Syd Shores** il maggiore in Eigenvector Centrality
...
::: {style="text-align: center;"}
<figure><img src="Final_works_images/silver.svg" alt="Collaborazioni tra artisti" style="max-width: 60%;"/></figure>
:::
...
**Stan Lee** il maggiore in Eigenvector e PageRank
...
::: {style="text-align: center;"}
<figure><img src="Final_works_images/bronze.svg" alt="Collaborazioni tra artisti" style="max-width: 60%;"/></figure>
:::
...
**Gil Kane** il maggiore in Eigenvector e PageRank
...
::: {style="text-align: center;"}
<figure><img src="Final_works_images/modern.svg" alt="Collaborazioni tra artisti" style="max-width: 60%;"/></figure>
:::
...
page <- page_rank(sub_g_largest_component)$vector
bet <- betweenness(sub_g_largest_component)
clos <- closeness(sub_g_largest_component)

stats <- tibble(
  Artista= V(sub_g_largest_component)$name,
...
important_collabs |>
  ...
  knitr::kable(
    format = "html",
    escape = FALSE,
    col.names = c("", "Collaborazioni", "Eigenvector", "PageRank", "Betweenness", "Closeness", "Prima Pubblicazione"),
    align = c('l', 'c', 'c', 'c', 'c', 'c'),
    caption = "Top Artisti"
  ) |>
  kableExtra::kable_styling(
...
1. **Stan Lee** dal 1941 ha pubblicato con 19 dei maggiori esponenti, per un totale di 250 albi
1. **Jack Kirby** ha pubblicato, dal 1940, con 16 dei maggiori esponenti, per un totale di 160 albi
3. **Gene Colan** dal 1950 ha pubblicato con 12 dei maggiori esponenti, per un totale di 128 albi
